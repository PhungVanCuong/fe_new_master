<template>
    <footer class="filmoja-footer-area mt-5" style="background-color: #000957;">
            ...
            <section>
                <div class="row text-start">
                    ...
                    <div class="col-lg-3 col-md-6 mb-4 mb-md-0">
                        <h5 class="text-uppercase fw-bold mb-3 text-light">Tr0ondCinema</h5>
                        <p>
        ...
        <div class="text-center p-3 bg-black">
            © 2025 Tr0ondCinema. All rights reserved.
        </div>
    </footer>
</template>
