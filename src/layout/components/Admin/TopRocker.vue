<template>
	<div class="topbar d-flex align-items-center">
		<nav class="navbar navbar-expand">
			<div class="topbar-logo-header position-relative" style="width: 200px;">
				<div class="">
					<router-link to="/admin/dashboard" class="navbar-brand fs-4 fw-bold text-decoration-none"
                    style="position: absolute; top: -50px; left: -30px; z-index: 1000;">
			...
			<div class="user-box dropdown">
				<a class="d-flex align-items-center nav-link dropdown-toggle dropdown-toggle-nocaret" href="#"
					...
					<div class="user-info ps-3 pe-3">
						<p class="user-name mb-0 ">{{ ho_va_ten }}</p>
					</div>
				</a>
				<ul class="dropdown-menu dropdown-menu-end">
					...
					<li>
						<a class="dropdown-item" @click="dangXuat()"><i
								class="bx bx-log-out-circle"></i><span>Logout</span></a>
					</li>
					<li>
						<a class="dropdown-item" @click="dangXuatAll()"><i class="bx bx-log-out-circle"></i><span>Logout
								All</span></a>
					</li>
				</ul>
			</div>
...
export default {
	...
	methods: {
		checkLogin() {
			...
			if (!token) return;
			axios.get(apiUrl('admin/check-token'), {
				headers: {
