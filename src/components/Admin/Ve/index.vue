            ...
            <div class="card radius-10 border-top border-0 border-3 border-info">
                ...
                <div class="card-body table-responsive">
                    <div class="input-group mb-3">
                        <input v-model="search_key" type="text" class="form-control" placeholder="Tìm kiếm mã vé, tên khách, tên phim...">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover">
                            ...
                            <tbody>
                                <!-- Đổi tên mảng dữ liệu từ list_ve thành filteredVe -->
                                <tr class="text-nowrap" v-for="(item, index) in filteredVe" :key="index">
...
export default {
    ...
    computed: {
        filteredVe() {
            ...
            // Lọc danh sách theo Mã vé, Tên khách hàng hoặc Tên phim
            return this.list_ve.filter(item => {
                return (item.ma_ve && item.ma_ve.toLowerCase().includes(keyword)) ||
                       (item.ho_va_ten && item.ho_va_ten.toLowerCase().includes(keyword)) ||
                       (item.ten_phim && item.ten_phim.toLowerCase().includes(keyword));
            });
        }
    },
    methods: {
