                            ...
                            <tbody>
                                <tr v-for="(item, index) in list_voucher" :key="index">
                                    ...
                                    <td @click="changeStatusVoucher(item)" class="text-center align-middle"
                                        style="width: 100px;">
                                        <span v-if="item.tinh_trang == 1" class="badge rounded-pill text-success bg-light-success p-2 text-uppercase px-3">
                                            <i class="bx bxs-circle me-1"></i> Hiển thị
                                        </span>
                                        <span v-else class="badge rounded-pill text-danger bg-light-danger p-2 text-uppercase px-3">
                                            <i class="bx bxs-circle me-1"></i> Tạm tắt
                                        </span>
                                    </td>
...
export default {
    ...
    methods: {
        ...
        addVoucher() {
            axios
                .post(apiUrl('admin/voucher/add-data'), this.create_voucher, {
                    headers: {
                        Authorization: "Bearer " + localStorage.getItem('key_admin')
                    }
                })
        ...
        updateVoucher() {
            axios
                .post(apiUrl('admin/voucher/update'), this.edit_voucher, {
                    headers: {
                        Authorization: "Bearer " + localStorage.getItem('key_admin')
                    }
                })
        ...
        deleteVoucher() {
            axios
                .post(apiUrl('admin/voucher/delete'), this.del_voucher, {
                    headers: {
                        Authorization: "Bearer " + localStorage.getItem('key_admin')
                    }
                })
