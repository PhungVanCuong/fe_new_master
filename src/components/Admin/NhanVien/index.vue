                ...
                <div class="card radius-10 border-top border-0 border-3 border-info">
                    ...
                    <div class="card-body table-responsive">
                        <div class="input-group mb-3">
                            <input v-model="search_key" type="text" class="form-control" placeholder="Tìm kiếm nhân viên (Tên, Email, SĐT...)">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    <!-- Đổi biến list_nhan_vien thành biến filteredNhanVien để lọc trong thanh tiềm kiếm-->
                                    <tr class="text-nowrap" v-for="(item, index) in filteredNhanVien" :key="index">
...
export default {
    ...
    computed: {
        filteredNhanVien() {
            // Nếu ô tìm kiếm trống, trả về nguyên danh sách ban đầu
            if (!this.search_key) {
                return this.list_nhan_vien;
            }
            
            // Chuyển từ khóa về chữ thường để tìm kiếm không phân biệt hoa thường
            const keyword = this.search_key.toLowerCase().trim();
            
            // Lọc danh sách nhân viên dựa trên Tên, Email hoặc SĐT
            return this.list_nhan_vien.filter(item => {
